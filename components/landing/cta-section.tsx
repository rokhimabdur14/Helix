          ...
          <div className="relative z-10 px-6 py-16 md:px-12 md:py-24 text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
                <span className="text-foreground">Ready to decode your</span>
                <br />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  <a
                    ...
                    className="btn-secondary px-10 py-4 rounded-xl text-base font-semibold text-foreground inline-flex items-center gap-2"
                  >
                    Contact Sales
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
