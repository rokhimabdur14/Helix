  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-foreground">The DNA of your brand,</span>
          <br />
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
            <a
              href="#how-it-works"
              className="btn-secondary px-8 py-4 rounded-xl text-base font-semibold text-foreground inline-flex items-center gap-2"
            >
              Watch Demo
              <svg
                className="w-5 h-5"
