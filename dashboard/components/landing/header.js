          ...
          <nav className="hidden md:flex items-center gap-8">
            {navItems.map((item, i) => (
              <motion.a
                ...
                className="text-sm text-slate-400 hover:text-slate-100 transition-colors relative group"
              >
                {item.label}
            ...
            <div className="px-4 py-6 space-y-4">
              {navItems.map((item) => (
                <a
                  ...
                  className="block text-lg text-slate-400 hover:text-slate-100 transition-colors"
                >
                  {item.label}
                </a>
              ))}
              <div className="pt-4 space-y-3">
                <Link
                  href="/chat"
                  className="block text-center py-2.5 text-slate-400 hover:text-slate-100 transition-colors"
                >
                  Sign In
                </Link>
                <Link
